...
Полный пример реализации ассинхронных запросов через библиотеку SuperAgent вы можете посмотреть в этом репозитории в файле [nodejs_react/front/src/API/index.js](front/src/API/index.js).
